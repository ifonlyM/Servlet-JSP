    ...
    <main class="notice-main">
            ...
            <tbody>
                <c:forEach items="${list}" var="b">
	               	<tr>
	               		...
	               		<td class="title"><p><a href="detail?bno=${b.bno}"><c:out value="${b.title}"/><span class="text-muted"> [${b.replyCnt}]</span></a></p></td>
	               		<td>${b.id}</td>
        ...
        <%	
        	...
        	if(session.getAttribute("member") != null){
        		out.print("<div class='notice-writebox'><a class='linkButton' href='/board/write?category=1'>글쓰기</a></div>");
        	}
        	else {
